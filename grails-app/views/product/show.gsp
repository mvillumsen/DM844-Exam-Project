...
<ol class="property-list product">
    ...
    <g:if test="${productInstance?.lastUpdated}">
        <li class="fieldcontain">
            ...
            <span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate
                    date="${productInstance?.lastUpdated}"/></span>

        </li>
    </g:if>

    <g:if test="${productInstance?.orderEntries}">
        <li class="fieldcontain">
            <span id="orderEntries-label" class="property-label"><g:message code="product.orderEntries.label"
    ...
    <g:if test="${productInstance?.stock}">
        <li class="fieldcontain">
            ...
            <span class="property-value" aria-labelledby="stock-label"><g:fieldValue bean="${productInstance}"
                                                                                     field="stock"/></span>
...
<g:form url="[resource: productInstance, action: 'delete']" method="DELETE">
    <fieldset class="buttons">
        <g:link class="btn btn-primary"  action="edit" resource="${productInstance}"><g:message code="default.button.edit.label"
                                                                                    default="Edit"/></g:link>
