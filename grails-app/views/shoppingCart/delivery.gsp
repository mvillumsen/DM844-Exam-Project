    ...
    <tb:radio>
        ...
        <fieldset id="alternativeAddress">
            ...
            <tb:formGroup>
                ...
                <tb:col8><tb:preFilledInputForm id="address1" name="address1" type="address" value="${it.address1}"/></tb:col8>
            </tb:formGroup>
            <tb:formGroup>
                ...
                <tb:col8><tb:preFilledInputForm id="address2" name="address2" type="text" value="${it.address2}"/></tb:col8>
            </tb:formGroup>
            <tb:formGroup>
                ...
                <tb:col8><tb:preFilledInputForm id="zipCode" name="zipCode" type="text" value="${it.zipCode}"/></tb:col8>
            </tb:formGroup>
            <tb:formGroup>
