		...
		<div id="list-order" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="order.employee.label" default="Employee" /></th>
				...
				<g:each in="${orderInstanceList}" status="i" var="orderInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${orderInstance.id}">${fieldValue(bean: orderInstance, field: "employee")}</g:link></td>
