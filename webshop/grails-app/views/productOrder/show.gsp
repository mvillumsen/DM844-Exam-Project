	...
	<body>
		...
		<div id="show-productOrder" class="content scaffold-show" role="main">
			...
			<ol class="property-list productOrder">
				...
				<li class="fieldcontain">
					<span id="orderEntries-label" class="property-label"><g:message code="productOrder.orderEntries.label" default="Order Entries" /></span>
				...
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="productOrder.dateCreated.label" default="Date Created" /></span>
					
						<span class="property-value" aria-labelledby="dateCreated-label"><g:formatDate date="${productOrderInstance?.dateCreated}" /></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdated-label" class="property-label"><g:message code="productOrder.lastUpdated.label" default="Last Updated" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate date="${productOrderInstance?.lastUpdated}" /></span>
				...
				<li class="fieldcontain">
					<span id="status-label" class="property-label"><g:message code="productOrder.status.label" default="Status" /></span>
					
						<span class="property-value" aria-labelledby="status-label"><g:fieldValue bean="${productOrderInstance}" field="status"/></span>
			...
			<g:form url="[resource:productOrderInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${productOrderInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
