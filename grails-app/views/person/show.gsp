...
<div id="show-person" class="content scaffold-show" role="main">
    ...
    <ol class="property-list person">
        ...
        <g:if test="${personInstance?.address}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="address-label"><g:link controller="address" action="show"
                                                                                     id="${personInstance?.address?.id}">${personInstance?.address?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${personInstance?.salary}">
            <li class="fieldcontain">
                <span id="salary-label" class="property-label"><g:message code="person.salary.label"
                                                                          default="Salary"/></span>

                <span class="property-value" aria-labelledby="salary-label"><g:fieldValue bean="${personInstance}"
                                                                                          field="salary"/></span>
        ...
        <g:if test="${personInstance?.dateHired}">
            <li class="fieldcontain">
                <span id="dateHired-label" class="property-label"><g:message code="person.dateHired.label"
                                                                             default="Date Hired"/></span>

                <span class="property-value" aria-labelledby="dateHired-label"><g:formatDate
                        date="${personInstance?.dateHired}"/></span>
        ...
        <g:if test="${personInstance?.assignedOrders}">
            <li class="fieldcontain">
                <span id="assignedOrders-label" class="property-label"><g:message code="person.assignedOrders.label"
                                                                                  default="Assigned Orders"/></span>

                <g:each in="${personInstance.assignedOrders}" var="a">
                    <span class="property-value" aria-labelledby="assignedOrders-label"><g:link
                            controller="productOrder" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></span>
                </g:each>
        ...
        <g:if test="${personInstance?.lastUpdated}">
            <li class="fieldcontain">
                <span id="lastUpdated-label" class="property-label"><g:message code="person.lastUpdated.label"
                                                                               default="Last Updated"/></span>

                <span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate
                        date="${personInstance?.lastUpdated}"/></span>
        ...
        <g:if test="${personInstance?.orders}">
            <li class="fieldcontain">
                <span id="orders-label" class="property-label"><g:message code="person.orders.label"
                                                                          default="Orders"/></span>

                <g:each in="${personInstance.orders}" var="o">
                    <span class="property-value" aria-labelledby="orders-label"><g:link controller="productOrder"
                                                                                        action="show"
